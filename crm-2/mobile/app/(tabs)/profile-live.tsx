...
const menuItems = [
  { icon: 'PR', label: 'Privacy Policy', route: '/privacy' },
  { icon: 'HS', label: 'Help & Support', route: '/support' },
  { icon: 'DL', label: 'Delete Account', route: '/delete-account' },
];

export default function ProfileLiveScreen() {
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <View style={styles.appInfo}>
        <Text style={styles.appVersion}>CRM Mobile v1.0.2</Text>
        <Text style={styles.appCompany}>Store-ready privacy controls enabled</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  menuIcon: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#4f46e5' },
