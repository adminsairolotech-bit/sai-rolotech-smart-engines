...
export default function LeadsLiveScreen() {
  ...
  return (
    <View style={styles.wrapper}>
      <View style={[styles.header, { paddingTop: insets.top + (Platform.OS === 'web' ? 67 : 12) }]}>
        ...
        <Text style={styles.headerCount}>Awaiting secure CRM connection</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.title}>No synced leads yet</Text>
        <Text style={styles.body}>
          Misleading demo pipeline ko replace kar diya gaya hai. Is screen par tabhi leads show hongi jab real backend data source configured aur accessible hoga.
        </Text>
      </View>
    </View>
  );
